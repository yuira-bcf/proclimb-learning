...
const navData = {
    ...
    chapters: [
        { href: "1css-basics.html", num: "1", text: "CSS基本設定" },
        { href: "2css-text.html", num: "2", text: "文字・文章の装飾" },
        { href: "3css-size.html", num: "3", text: "幅と高さ" },
        { href: "4css-spacing.html", num: "4", text: "余白" },
        { href: "5css-border.html", num: "5", text: "線" },
        { href: "6css-flexbox.html", num: "6", text: "レイアウト" },
        { href: "7css-grid.html", num: "7", text: "グリッドレイアウト" },
...
function generateNavHTML() {
    ...
    // ロゴのアクティブ判定
    const logoActive = currentPage === '1css-basics.html' ? ' active' : '';
