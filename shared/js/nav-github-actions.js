/**
 * GitHub Actions入門 チュートリアル ナビゲーション
...
const navData = {
    logo: {
        ...
        icon: "play_circle",
        iconType: "material",
        text: "GitHub Actions入門"
    },
    chapters: [
        { href: "1actions-introduction.html", num: "1", text: "CI/CDとGitHub Actions入門" },
        { href: "2actions-workflow-basics.html", num: "2", text: "ワークフローの基本構造" },
        { href: "3actions-triggers.html", num: "3", text: "トリガーとイベント" },
        { href: "4actions-jobs-runners.html", num: "4", text: "ジョブとランナー" },
        { href: "5actions-steps-actions.html", num: "5", text: "ステップとアクション活用" },
        { href: "6actions-env-secrets.html", num: "6", text: "環境変数とシークレット" },
        { href: "7actions-cache-artifacts.html", num: "7", text: "キャッシュとアーティファクト" },
        { href: "8actions-ci-testing.html", num: "8", text: "CI実践：テスト自動化" },
        { href: "9actions-cd-deploy.html", num: "9", text: "CD実践：自動デプロイ" },
        { href: "10actions-advanced.html", num: "10", text: "カスタムアクションとセキュリティ" }
    ],
    categories: [
...
function generateNavHTML() {
    ...
    // ロゴのアクティブ判定
    const logoActive = currentPage === '1actions-introduction.html' ? ' active' : '';
    const logoIcon = renderIcon(navData.logo.icon, navData.logo.iconType);

    return `
        <div class="nav-container">
            <a href="${navData.logo.href}" class="nav-logo${logoActive}">
                <span class="nav-logo-icon" style="background: #2088FF; color: white;">${logoIcon}</span>
