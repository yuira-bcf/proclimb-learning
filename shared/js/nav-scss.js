...
const navData = {
    ...
    chapters: [
        { href: "1scss-intro.html", num: "1", text: "SCSSとは" },
        { href: "2scss-setup.html", num: "2", text: "環境構築と基本的な使い方" },
        { href: "3scss-variables-nesting.html", num: "3", text: "変数とネスト" },
        { href: "4scss-mixins.html", num: "4", text: "ミックスイン" },
        { href: "5scss-partials.html", num: "5", text: "パーシャルと@use" },
        { href: "6scss-extend.html", num: "6", text: "継承（@extend）" },
        { href: "7scss-functions.html", num: "7", text: "関数・演算・制御構文" },
        { href: "8scss-practice.html", num: "8", text: "実践プロジェクト" }
    ],
    categories: [
...
function generateNavHTML() {
    ...
    // ロゴのアクティブ判定
    const logoActive = currentPage === '1scss-intro.html' ? ' active' : '';
    const logoIcon = renderIcon(navData.logo.icon, navData.logo.iconType);

    return `
        <div class="nav-container">
            <a href="${navData.logo.href}" class="nav-logo${logoActive}">
                <span class="nav-logo-icon" style="background: #CF649A; color: white;">${logoIcon}</span>
