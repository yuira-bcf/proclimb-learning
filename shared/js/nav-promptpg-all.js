...
const navData = {
    logo: {
        ...
        icon: "view_compact",
        iconType: "material",
        text: "プロンプトPG オールインワン版"
    },
    steps: [
        { href: "../promptpg-step/promptpg-1.html", num: "1", text: "Hello! Spring Boot" },
        { href: "../promptpg-step/promptpg-2.html", num: "2", text: "画面作成（リンク遷移）" },
        { href: "../promptpg-step/promptpg-3.html", num: "3", text: "フォームデータ持ち回り" },
        { href: "../promptpg-step/promptpg-4.html", num: "4", text: "データベース設定" },
        { href: "../promptpg-step/promptpg-5.html", num: "5", text: "データ登録" },
        { href: "../promptpg-step/promptpg-6.html", num: "6", text: "一覧表示" },
        { href: "../promptpg-step/promptpg-7.html", num: "7", text: "削除機能" },
        { href: "../promptpg-step/promptpg-8.html", num: "8", text: "編集機能" }
    ],
    promptpg: [
        ...
        { href: "index.html", text: "オールインワン版", icon: "view_compact", iconType: "material" },
