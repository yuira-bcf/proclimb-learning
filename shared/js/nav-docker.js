...
const navData = {
    ...
    chapters: [
        { href: "1docker-introduction.html", num: "1", text: "コンテナ技術入門" },
        { href: "2docker-setup.html", num: "2", text: "Docker Desktopの導入" },
        { href: "3docker-image-container.html", num: "3", text: "イメージとコンテナの基礎" },
        { href: "4dockerfile.html", num: "4", text: "Dockerfileの書き方" },
        { href: "5docker-compose.html", num: "5", text: "Docker Composeの基礎" },
        { href: "6docker-volume-network.html", num: "6", text: "ボリュームとネットワーク" },
        { href: "7docker-webapp.html", num: "7", text: "実践：Webアプリのコンテナ化" },
        { href: "8docker-hub.html", num: "8", text: "Docker Hubとイメージ管理" },
        { href: "9docker-dev-environment.html", num: "9", text: "開発環境の構築" },
...
function generateNavHTML() {
    ...
    // ロゴのアクティブ判定
    const logoActive = currentPage === '1docker-introduction.html' ? ' active' : '';
